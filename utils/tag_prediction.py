...
vectorizer = joblib.load("utils/Fitted_countvectorizer.pkl")
scaler = joblib.load("utils/MaxAbsScaler.pkl")
classifier = joblib.load("utils/XGBClassifierPredictor.pkl")
tag_label = joblib.load("utils/multilabel_tag_binerizer.pkl")
